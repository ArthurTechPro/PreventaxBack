...
export class EstadoCliClientesController {
  ...
  async find(
    ...
    return this.estadoCliRepository.FKEstCli(id).find(filter);
  }
  ...
  async create(
    ...
    return this.estadoCliRepository.FKEstCli(id).create(clientes);
  }
  ...
  async patch(
    ...
    return this.estadoCliRepository.FKEstCli(id).patch(clientes, where);
  }
  ...
  async delete(
    ...
    return this.estadoCliRepository.FKEstCli(id).delete(where);
  }
}
