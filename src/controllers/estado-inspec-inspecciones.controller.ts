...
export class EstadoInspecInspeccionesController {
  ...
  async find(
    ...
    return this.estadoInspecRepository.FKEstInsp(id).find(filter);
  }
  ...
  async create(
    ...
    return this.estadoInspecRepository.FKEstInsp(id).create(inspecciones);
  }
  ...
  async patch(
    ...
    return this.estadoInspecRepository.FKEstInsp(id).patch(inspecciones, where);
  }
  ...
  async delete(
    ...
    return this.estadoInspecRepository.FKEstInsp(id).delete(where);
  }
}
