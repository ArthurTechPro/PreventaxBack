...
export class EstadoProdProductosController {
  ...
  async find(
    ...
    return this.estadoProdRepository.EstProd(id).find(filter);
  }
  ...
  async create(
    ...
    return this.estadoProdRepository.EstProd(id).create(productos);
  }
  ...
  async patch(
    ...
    return this.estadoProdRepository.EstProd(id).patch(productos, where);
  }
  ...
  async delete(
    ...
    return this.estadoProdRepository.EstProd(id).delete(where);
  }
}
