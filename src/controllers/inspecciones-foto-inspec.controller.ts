...
export class InspeccionesFotoInspecController {
  ...
  async find(
    ...
    return this.inspeccionesRepository.FKInsFoto(id).find(filter);
  }
  ...
  async create(
    ...
    return this.inspeccionesRepository.FKInsFoto(id).create(fotoInspec);
  }
  ...
  async patch(
    ...
    return this.inspeccionesRepository.FKInsFoto(id).patch(fotoInspec, where);
  }
  ...
  async delete(
    ...
    return this.inspeccionesRepository.FKInsFoto(id).delete(where);
  }
}
