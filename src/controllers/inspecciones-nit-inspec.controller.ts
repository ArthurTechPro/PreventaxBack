...
export class InspeccionesNitInspecController {
  ...
  async find(
    ...
    return this.inspeccionesRepository.FKIspNit(id).find(filter);
  }
  ...
  async create(
    ...
    return this.inspeccionesRepository.FKIspNit(id).create(nitInspec);
  }
  ...
  async patch(
    ...
    return this.inspeccionesRepository.FKIspNit(id).patch(nitInspec, where);
  }
  ...
  async delete(
    ...
    return this.inspeccionesRepository.FKIspNit(id).delete(where);
  }
}
