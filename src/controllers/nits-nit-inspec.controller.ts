...
export class NitsNitInspecController {
  ...
  async find(
    ...
    return this.nitsRepository.FKNitIsnp(id).find(filter);
  }
  ...
  async create(
    ...
    return this.nitsRepository.FKNitIsnp(id).create(nitInspec);
  }
  ...
  async patch(
    ...
    return this.nitsRepository.FKNitIsnp(id).patch(nitInspec, where);
  }
  ...
  async delete(
    ...
    return this.nitsRepository.FKNitIsnp(id).delete(where);
  }
}
