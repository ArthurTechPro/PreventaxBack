...
export class ProductosInspeccionesController {
  ...
  async find(
    ...
    return this.productosRepository.FKProdInspec(id).find(filter);
  }
  ...
  async create(
    ...
    return this.productosRepository.FKProdInspec(id).create(inspecciones);
  }
  ...
  async patch(
    ...
    return this.productosRepository.FKProdInspec(id).patch(inspecciones, where);
  }
  ...
  async delete(
    ...
    return this.productosRepository.FKProdInspec(id).delete(where);
  }
}
