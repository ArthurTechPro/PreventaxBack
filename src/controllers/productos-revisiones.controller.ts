...
export class ProductosRevisionesController {
  ...
  async find(
    ...
    return this.productosRepository.FKProRev(id).find(filter);
  }
  ...
  async create(
    ...
    return this.productosRepository.FKProRev(id).create(revisiones);
  }
  ...
  async patch(
    ...
    return this.productosRepository.FKProRev(id).patch(revisiones, where);
  }
  ...
  async delete(
    ...
    return this.productosRepository.FKProRev(id).delete(where);
  }
}
