...
export class RevisionesComentariosController {
  ...
  async find(
    ...
    return this.revisionesRepository.FKRevComent(id).find(filter);
  }
  ...
  async create(
    ...
    return this.revisionesRepository.FKRevComent(id).create(comentarios);
  }
  ...
  async patch(
    ...
    return this.revisionesRepository.FKRevComent(id).patch(comentarios, where);
  }
  ...
  async delete(
    ...
    return this.revisionesRepository.FKRevComent(id).delete(where);
  }
}
