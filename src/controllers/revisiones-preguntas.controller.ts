...
export class RevisionesPreguntasController {
  ...
  async find(
    ...
    return this.revisionesRepository.KFRevPreg(id).find(filter);
  }
  ...
  async create(
    ...
    return this.revisionesRepository.KFRevPreg(id).create(preguntas);
  }
  ...
  async patch(
    ...
    return this.revisionesRepository.KFRevPreg(id).patch(preguntas, where);
  }
  ...
  async delete(
    ...
    return this.revisionesRepository.KFRevPreg(id).delete(where);
  }
}
