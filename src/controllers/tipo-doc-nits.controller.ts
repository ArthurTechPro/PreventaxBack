...
export class TipoDocNitsController {
  ...
  async find(
    ...
    return this.tipoDocRepository.FKTipoNit(id).find(filter);
  }
  ...
  async create(
    ...
    return this.tipoDocRepository.FKTipoNit(id).create(nits);
  }
  ...
  async patch(
    ...
    return this.tipoDocRepository.FKTipoNit(id).patch(nits, where);
  }
  ...
  async delete(
    ...
    return this.tipoDocRepository.FKTipoNit(id).delete(where);
  }
}
