...
export class VehMarcaVehiculosController {
  ...
  async find(
    ...
    return this.vehMarcaRepository.FKMarVeh(id).find(filter);
  }
  ...
  async create(
    ...
    return this.vehMarcaRepository.FKMarVeh(id).create(vehiculos);
  }
  ...
  async patch(
    ...
    return this.vehMarcaRepository.FKMarVeh(id).patch(vehiculos, where);
  }
  ...
  async delete(
    ...
    return this.vehMarcaRepository.FKMarVeh(id).delete(where);
  }
}
