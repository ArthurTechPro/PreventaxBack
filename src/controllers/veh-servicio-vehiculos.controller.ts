...
export class VehServicioVehiculosController {
  ...
  async find(
    ...
    return this.vehServicioRepository.FKSvcVeh(id).find(filter);
  }
  ...
  async create(
    ...
    return this.vehServicioRepository.FKSvcVeh(id).create(vehiculos);
  }
  ...
  async patch(
    ...
    return this.vehServicioRepository.FKSvcVeh(id).patch(vehiculos, where);
  }
  ...
  async delete(
    ...
    return this.vehServicioRepository.FKSvcVeh(id).delete(where);
  }
}
