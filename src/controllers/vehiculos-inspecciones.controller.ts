...
export class VehiculosInspeccionesController {
  ...
  async find(
    ...
    return this.vehiculosRepository.FKVehInspec(id).find(filter);
  }
  ...
  async create(
    ...
    return this.vehiculosRepository.FKVehInspec(id).create(inspecciones);
  }
  ...
  async patch(
    ...
    return this.vehiculosRepository.FKVehInspec(id).patch(inspecciones, where);
  }
  ...
  async delete(
    ...
    return this.vehiculosRepository.FKVehInspec(id).delete(where);
  }
}
